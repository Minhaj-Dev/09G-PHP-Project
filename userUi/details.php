...
include("header.php");
$idURL = $_GET['id']; 
$query = "SELECT * FROM Products where p_id = '$idURL'";
                ...
                <div class="col-lg-6 col-md-6">
                   <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="../AdminPanel/uploads/<?php echo $data['p_image'] ?>" data-zoom-image="../AdminPanel/uploads/<?php echo $data['p_image'] ?>" alt="big-1">
                            </a>
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <div class="price_box">
                                <span class="current_price">$<?php echo $data['p_price'] ?>
                                </span>
