...
if(isset($_POST['btnRegister'])){
    ...
    $hashPass = password_hash($pass,PASSWORD_DEFAULT);
        ...
        $runQuery = mysqli_query($conn,$emailCheck);
        $numberOfRecords = mysqli_num_rows($runQuery);

        if($numberOfRecords>0){
            echo "Email Already Exist Please Login Yourself";
        }else{
            $insertQuery = "INSERT INTO users (`user_name`,`user_email`,`user_password`,`user_role`) VALUES('$name','$email','$hashPass',2)";
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                              ...
                              <input type="submit" value="Register Account!" class="btn btn-primary btn-user btn-block" name="btnRegister">
